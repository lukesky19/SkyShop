 ...
 */
public class CommandPrePurchaseEvent extends Event implements Cancellable {
     ...
     */
    public CommandPrePurchaseEvent(@NonNull Player player, @NonNull List<String> commands) {
        this.player = player;
