...
/**
 * The configuration to buy/sell commands.
 * @param version The version of the configuration.
 * @param id The id the configuration is associated with. Used to tie it with a processor and serializer.
 * @param buyCommands The {@link List} of {@link String}s for the commands to buy.
 * @param sellCommands The {@link List} of {@link String}s for the commands to sell.
 */
@ConfigSerializable
