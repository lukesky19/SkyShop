 ...
 */
public class ItemConfigurationSerializer extends ConfigurationSerializer<ItemConfiguration> {
    /**
     * Constructor
     */
    public ItemConfigurationSerializer() {
        super(ItemConfiguration.class);
    }
